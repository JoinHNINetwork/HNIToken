...
contract HNIToken is ReentrancyGuard, Pausable, ERC20SafeTransfer {
     ...
     * @param _token The underlying token.
     * @return Current exchange rate between token and HNIToken.
     */
    function getCurrentExchangeRateByHandler(
        ...
        // Reset exchange rate to 1 when there is no HNIToken left
     ...
     * @param _dst Account who will get HNIToken.
        ...
        whenNotPaused
    {
        ...
        // Calculate amount of the HNIToken based on current exchange rate.
    ...
    /**
     * @dev Redeem token according to input HNIToken amount,
     *      but only when the contract is not paused.
     * @param _src Account who will spend HNIToken.
     * @param _wad Amount to burn HNIToken, scaled by 1e18.
     */
        ...
        whenNotPaused
    {
        ...
        // Transfer fee from the default handler(the temporary pool) to HNIToken.
        ...
        whenNotPaused
    {
        ...
        _redeemLocal.originationFee = originationFee[HNIToken(this)
            .redeem
            .selector];
     ...
     *      based on the HNIToken amount, which has substracted HNIToken fee.
     * @param _account Account to query token balance.
     * @return Actual token balance based on HNIToken amount.
     */
   ...
   */
        ...
        )
    {
        ...
        return (
            ...
            originationFee[HNIToken(this).mint.selector],
            originationFee[HNIToken(this).redeem.selector],
            _tokenTotalBalance
        );
    }
